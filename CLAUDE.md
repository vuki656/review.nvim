...
│   ├── limits.lua              # Size caps and binary detection for diffs and source files
...
│   ├── file_tree.lua           # Files panel: file list with status icons and line stats
